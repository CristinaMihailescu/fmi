...
{-
2. Valoarea totala a valutei dintr-un string
Bonus: doar valuta straina (ignora lei)
Rata de conversie este data de functia rata
Folosind recursivitate si functii din categ A, B
...
413  -- 10 lei + 100*4 eur + 1*3 dolari

403  -- Bonus: 10 lei ignorat + 100*4 eur + 1*3 dolari
-}
rata :: Char -> Int
rata 'l' = 1  -- ron
rata '$' = 3  -- dolari
...
{-
3. Cenzurare numere - inlocuire fiecare cifra dintr-un string cu X
...
Bonus: intoarce o pereche unde pe a doua pozitie se afla:
